...
test.describe("Wallet Connection", () => {
	...
	test("should connect MetaMask wallet to the dApp", async ({ context, page, metamaskPage, extensionId }) => {
	...
	test("should switch to Citrea Testnet network", async ({ context, page, metamaskPage, extensionId }) => {
		const metamask = new MetaMask(context, metamaskPage, basicSetup.walletPassword, extensionId);
