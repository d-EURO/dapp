...
export default function CoverageSummary() {
	...
	return (
		<AppCard>
			...
			<a
				href={`${WAGMI_CHAIN.blockExplorers?.default.url || "https://etherscan.io"}/token/${ADDRESS[WAGMI_CHAIN.id].decentralizedEURO}`}
				target="_blank"
				rel="noopener noreferrer"
				className="flex items-baseline gap-2 mb-4 hover:opacity-80"
			>
